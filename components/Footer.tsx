...
export default function Footer() {
  return (
    <footer className="border-t" style={{ background: '#EDE4CC', borderColor: '#D9C99A' }}>
      <div className="max-w-7xl mx-auto px-5 sm:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-14">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              {[
                ...
                <li key={link.label}>
                  <Link href={link.href} className="text-sm tracking-wide transition-opacity hover:opacity-50" style={{ color: '#2A1E08' }}>
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h4 className="text-[11px] font-semibold mb-5 tracking-[0.25em] uppercase" style={{ color: '#968148' }}>Enquiries</h4>
            <ul className="flex flex-col gap-3 text-sm" style={{ color: '#2A1E08' }}>
              <li style={{ color: '#7A6535' }}>Baja California Sur, México</li>
              <li>
        ...
        <div className="pt-8 border-t flex flex-col sm:flex-row justify-between items-center gap-3" style={{ borderColor: '#D9C99A' }}>
          <p className="text-[11px] tracking-[0.2em] uppercase" style={{ color: '#C9B889' }}>
